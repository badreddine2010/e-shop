...
<a class="nav" href="<?php echo RACINE_SITE; ?>vue/connexion.php"><i class="bi bi-person-check"></i><?=$_SESSION['membre']['prenom']?><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-check" viewBox="0 0 16 16">
