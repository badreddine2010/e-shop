...
<link href="<?php echo RACINE_SITE; ?>ctrl/img/logo2.png" rel="icon" type="image/png" />
		<title>e-shop.com</title>
			...
			<center><?php echo "<img src='".RACINE_SITE ."ctrl/img/logo2.png' width='102' height='52' />";
 ?> </center>
...
<a class="nav" ><?=$_SESSION['membre']['prenom']?><i class="bi bi-person-check-fill"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person-check-fill" viewBox="0 0 16 16">
  ...
  <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
		...
		<li class="nav-item">
          <a class="nav-link" href="<?php echo RACINE_SITE; ?>vue/panier.php">panier<i class="bi bi-cart"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
  <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l1.313 7h8.17l1.313-7H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
</svg></i></a>
        </li>
		<li class="nav-item">
          <a class="nav-link" href="<?php echo RACINE_SITE; ?>vue/connexion.php">connexion<i class="bi bi-person"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
