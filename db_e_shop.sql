...
(6, '56-a-65', 'chemise', 'Chemise Blanche', 'Les chemises c''est bien mieux que les tshirts', 'blanc', 'L', 'm', 'http://localhost:8080/e_shop/photo/56-a-65_chemiseblanchem.jpg', 49, 73),
(7, '63-s-63', 'chemise', 'Chemise Noir', 'Comme vous pouvez le voir c''est une chemise noir...', 'noir', 'M', 'm', 'http://localhost:8080/e_shop/photo/63-s-63_chemisenoirm.jpg', 59, 120),
(8, '77-p-79', 'pull', 'Pull gris', 'Pull gris pour l''hiver', 'gris', 'XL', 'f', 'http://localhost:8080/e_shop/photo/77-p-79_pullgrism2.jpg', 79, 99),
(9, '77-l-79', 'pantalon', 'Pull gris', 'Pull gris pour l''hiver', 'gris', 'XL', 'f', 'http://localhost:8080/e_shop/photo/77-p-79_pullgrism2.jpg', 79, 99),
(10, '56-a-67', 'montre', 'Chemise Blanche', 'Les chemises c''est bien mieux que les tshirts', 'blanc', 'L', 'm', 'http://localhost:8080/e_shop/photo/56-a-65_chemiseblanchem.jpg', 49, 73),
